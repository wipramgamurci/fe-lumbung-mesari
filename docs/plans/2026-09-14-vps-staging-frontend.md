...
**Files:**
- Create: `.dockerignore`, `Dockerfile`, `docker-compose.staging.yml`; update `.env.example`
...
3. Resolve Compose with a temporary `.env`; assert project name, port `3002`, and immutable image reference.
