...
const selectedFilter = ref("allUsers");
...
const dropdownItems = ref([
  {
    ...
    value: "allUsers",
    onSelect: () => onDropdownSelect("allUsers"),
  },
  {
  ...
  },
  {
    ...
    onSelect: () => onDropdownSelect("administrators"),
  },
]);
...
const queryParams = computed(() => {
  ...
  switch (selectedFilter.value) {
    case "allUsers":
      // No additional params - just page and limit
      break;
    case "activeMembers":
      baseQuery.role = "member";
